      ...
      <div className="max-w-5xl mx-auto">
          ...
          <div className="flex justify-between items-start gap-4 flex-wrap">
            ...
            <div className="flex gap-2 flex-wrap items-center">
              ...
              <button
                ...
                className={`font-semibold rounded-lg px-4 py-2 text-sm transition-colors flex items-center gap-2 ${
                  isGeneratingAudit
              ...
              >
                {isGeneratingAudit ? (
                  ...
                  <>
                    ...
                    Generate Audit Program from Assessment
                  </>
                )}
              </button>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow p-4 mb-5 flex justify-between items-center flex-wrap gap-3">
          <p className="text-sm text-gray-500">
            Review complete? Generate an audit program informed by this governance assessment.
          </p>
          <div className="flex gap-2">
            ...
            <button
              onClick={onGenerateAuditProgram}
              disabled={isGeneratingAudit}
              className={`font-semibold rounded-lg px-4 py-2 text-sm transition-colors ${
                isGeneratingAudit
                  ? 'bg-indigo-400 text-white cursor-not-allowed'
                  : 'bg-indigo-600 hover:bg-indigo-700 text-white'
              }`}
            >
              {isGeneratingAudit ? 'Generating...' : 'Generate Audit Program from Assessment'}
            </button>
          </div>
        </div>
